...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2022 at 07:30 PM
...
(26, 1, 1, '2500', 1, '0.90', 1),
(28, 10, 2, '5555', 1, '4999.50', 1),
(29, 10, 15, '10000', 1, '9000.00', 1),
(30, 10, 3, '0', 1, '0.90', 1),
(32, 11, 18, '10000', 1, '9000.00', 1);
...
(13, 'dipta', 'dipta995@gmail.com', '12345678909', '', '1234567890', '2022-03-25 06:57:45', 1215469846);
...
--
ALTER TABLE `enrole_student_list`
  MODIFY `enrole_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `ratecheck_table`
  MODIFY `ratcheck_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
